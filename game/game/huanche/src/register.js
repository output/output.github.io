...
//        var linkto = "./hope.html" + "?frined=" + $("friendname").val() + "&content=" + $("saycontent").val() + "&img=" + $("selectedImg").val();
        var linkto = "./hope.html" + "?f=" + encodeURI(getById("friendname").value.trim()) + "&c=" + encodeURI(getById("saycontent").value.trim()) + "&img=" + encodeURI(getById("selectedImg").value.trim());

//        window.wxData.title = "大玩具许愿精灵";
        window.wxData.desc = getById("friendname").value.trim() + " ：" + getById("saycontent").value.trim();
...
var checkForm = function () {
    ...
    */
    ...
    if($("#friendname").val() == ""){
//        alert("请输入他的名字哦");
        window["showAlert"]("请输入他的名字哦");
        return false;
    }else if($("#saycontent").val() == ""){
//        alert("请填写换车宣言哦");
        window["showAlert"]("请填写换车宣言哦");
        return false;
    }else if($("#selectedImg").val() == "" || $("#selectedImg").val() == "0" ){
//        alert("请输选择配图哦");
        window["showAlert"]("请输选择配图哦");
