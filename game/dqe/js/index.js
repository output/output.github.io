...
;~function(res){
	...
	res.load = function(){
        ...
        res.queue.loadFile("img/zhangai.png");
	}
...
Main.shareTextMap = {
	...
	,"1": {
		tip: "没吃饱饭吗,用力用力!!"
		,title: "我把" + Main.ZAType + "打出了${m}米，击败了${n}%人，来挑战我吧！"
	}
	,"2": {
		tip: "死鬼!想把我打去北极吗!"
		,title: "我把" + Main.ZAType + "打出了${m}米，击败了${n}%人，来挑战我吧！"
...
// 选择障碍画面
Main.selectZhangai = function(isInit){
    var container = new createjs.Container();
    container.addChild(new createjs.Bitmap(Resource.get("img/start.png")));

    var z1 = new createjs.Bitmap(Resource.get("img/zhangai.png"));
    z1.setTransform(140, 100);
    z1.cursor = "pointer";
    ...
    container.addChild(z1);

    var z2 = new createjs.Bitmap(Resource.get("img/zhangai.png"));
    z2.setTransform(410, 100);
    z2.cursor = "pointer";
    ...
    container.addChild(z2)

    var z3 = new createjs.Bitmap(Resource.get("img/zhangai.png"));
    z3.setTransform(140, 300);
    z3.cursor = "pointer";
    ...
    container.addChild(z3);

    var z4 = new createjs.Bitmap(Resource.get("img/zhangai.png"));
    z4.setTransform(410, 300);
    z4.cursor = "pointer";
    ...
    container.addChild(z4);

    var z5 = new createjs.Bitmap(Resource.get("img/zhangai.png"));
    z5.setTransform(140, 500);
    z5.cursor = "pointer";
    ...
    container.addChild(z5);

    var z6 = new createjs.Bitmap(Resource.get("img/zhangai.png"));
    z6.setTransform(410, 500);
    z6.cursor = "pointer";
    ...
    container.addChild(z6);

    var z7 = new createjs.Bitmap(Resource.get("img/zhangai.png"));
    z7.setTransform(140, 700);
    z7.cursor = "pointer";
    ...
    container.addChild(z7);

    var z8 = new createjs.Bitmap(Resource.get("img/zhangai.png"));
    z8.setTransform(410, 700);
    z8.cursor = "pointer";
...
Main.updateZhangai = function(){
    Main.zhangai1.x = Main.penguin.x;
    Main.zhangai1.y = Main.penguin.y;

    console.log("障碍：x:"+Main.penguin.x + "----" + "y : "+ Main.penguin.y);
}
...
Main.initGame = function(){
    ...
    var zhangai1 = new createjs.Text(Main.ZAType, "36px Arial Black", Main.ZAColor);

    this.zhangai1 = zhangai1;
    zhangai1.x = this.penguin.x;
    zhangai1.y = this.penguin.y;
    zhangai1.zIndex = 100;
    this.stage.addChild(zhangai1);
    this.reset.zhangai();

    createjs.Ticker.addEventListener("tick", Main.updateZhangai);
...
Main.reset = {
    ...
    zhangai:function(){
        ...
        var zhangai1 = Main.zhangai1;
        zhangai1.x = Main.width - Main.penguinOffsetX;
        zhangai1.y = 0;
        zhangai1.alpha = 1;
        zhangai1.rotation = 0;

        zhangai1.text=Main.ZAType;
        zhangai1.color=Main.ZAColor;
        zhangai1.font=("56px Arial Black");
...
Main.on("stageClick", function(clickTime){
	...
	if(!Main.isPlaying){
		...
		if(Main.isQuiver){
            ...
            createjs.Ticker.removeEventListener("tick", Main.updateZhangai);
//            Main.zhangai1.alpha=0;
