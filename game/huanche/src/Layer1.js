var Layer1 = cc.Layer.extend({
    ...
    initUI: function () {
        ...
        this.logo = new cc.LabelTTF("大玩具新年愿望", "微软雅黑", GC.h * 0.07);
        this.logo.scale = 0;
        this.logo.setPosition(cc.pAdd(cc.visibleRect.center, cc.p(0, this.logo.height / 3 * 2)));
        this.logo.setColor(new cc.Color(255,255,0));
        this.addChild(this.logo);

        this.title = new cc.LabelTTF("给你一次换车的机会", "微软雅黑", GC.h * 0.045);
        this.title.scale = 0;
        this.title.setPosition(cc.pAdd(cc.visibleRect.center, cc.p(0, - this.logo.height / 3 * 2)));
        this.title.setColor(new cc.Color(255,255,0));
...
//        this.addChild(this.rightFont);
    ...
    appear: function () {
        var logoAction = cc.sequence(cc.scaleTo(0.5, 1), cc.callFunc(function () {
            ...
            this.title.rightDownAction = cc.scaleTo(0.5, 1);
            this.title.runAction(this.title.rightDownAction);
...
//            this.title.runAction(this.title.rightDownAction.reverse());

            this.title.rightDownAction = cc.scaleTo(0.5, 0);
            this.title.runAction(this.title.rightDownAction);
