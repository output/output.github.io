...
//        this.appear();
    ...
    appear: function () {//20,50,80,100
        ...
        var action = cc.sequence(
            cc.delayTime(0.2),
            cc.progressTo(0.3, 20),
            cc.callFunc(function () {
                this.firstPoint.inAction = cc.scaleTo(0.2, 1);
                this.firstPoint.runAction(this.firstPoint.inAction);
                this.firstText.inAction = cc.sequence(
                    cc.delayTime(0.2),
                    cc.spawn(
                        cc.moveTo(0.2,
                            cc.p(this.firstText.x - this.firstText.width / 2, this.firstText.y)),
                        cc.fadeIn(0.5)
                    )
                );
            ...
            cc.delayTime(0.7),
            cc.progressTo(0.3, 50),
            cc.callFunc(function () {
                this.secondPoint.inAction = cc.scaleTo(0.2, 1);
                this.secondPoint.runAction(this.secondPoint.inAction);
                this.secondText.inAction = cc.sequence(
                    cc.delayTime(0.2),
                    cc.spawn(
                        cc.moveTo(0.2,
                            cc.p(this.secondText.x + this.secondText.width / 2, this.secondText.y)),
                        cc.fadeIn(0.5)
                    )
                );
            ...
            cc.delayTime(0.7),
            cc.progressTo(0.3, 80),
            cc.callFunc(function () {
                this.thirdPoint.inAction = cc.scaleTo(0.2, 1);
                this.thirdPoint.runAction(this.thirdPoint.inAction);
                this.thirdText.inAction = cc.sequence(cc.delayTime(0.2),
                    cc.spawn(
                        cc.moveTo(0.2,
                            cc.p(this.thirdText.x - this.thirdText.width / 2, this.thirdText.y)),
                        cc.fadeIn(0.5)
                    )
                );
...
//            this.disappear();
    ...
    disappear: function (callback, target) {
        ...
        this.line.runAction(action);
        this.thirdPoint.inAction = cc.sequence(
            cc.delayTime(0.2),
            cc.scaleTo(0.2, 0)
        );
        this.thirdPoint.runAction(this.thirdPoint.inAction);
        this.thirdText.inAction = cc.spawn(
            cc.moveTo(0.3,
                cc.p(this.thirdText.x + this.thirdText.width / 2,
                    this.thirdText.y)
            ), cc.fadeOut(0.3)
        );
        this.thirdText.runAction(this.thirdText.inAction);
        this.secondPoint.inAction = cc.sequence(
            cc.delayTime(0.2),
            cc.scaleTo(0.2, 0)
        );
        this.secondPoint.runAction(this.secondPoint.inAction);
        this.secondText.inAction = cc.spawn(
            cc.moveTo(0.5,
                cc.p(this.secondText.x - this.secondText.width / 2,
                    this.secondText.y)
            ), cc.fadeOut(0.3)
        );
        this.secondText.runAction(this.secondText.inAction);
        this.firstPoint.inAction = cc.sequence(cc.delayTime(0.2),
            cc.scaleTo(0.2, 0)
        );
        this.firstPoint.runAction(this.firstPoint.inAction);
        this.firstText.inAction = cc.spawn(
            cc.moveTo(0.3,
                cc.p(this.firstText.x + this.firstText.width / 2,
                    this.firstText.y)
            ), cc.fadeOut(0.3)
        );
        this.firstText.runAction(this.firstText.inAction);
