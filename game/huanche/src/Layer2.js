...
//        this.appear();
    ...
    initUI: function () {
        ...
        this.fontLogo = new cc.Sprite(res.page2_center);
        this.fontLogo.setPosition(cc.pAdd(cc.visibleRect.center, cc.p(0, 0)));
        this.fontLogo.setScale(0);
        this.addChild(this.fontLogo);


        this.title1 = new cc.LabelTTF("踩下油门的一刹那，你知道，\n他不是你的真爱", "微软雅黑", GC.h * 0.045);
        this.title1.scale = 0;
        this.title1.setPosition(GC.w_2, GC.h * 0.75);
        this.title1.setColor(new cc.Color(255,255,0));
        this.addChild(this.title1);


        this.title2 = new cc.LabelTTF("不管你是在寻找真爱……", "微软雅黑", GC.h * 0.068);
//        this.title2.scale = 0;
//        this.title2.setPosition(GC.w_2, GC.h * 0.2);
        this.title2.setPosition(cc.pAdd(cc.visibleRect.bottom, cc.p(0, -this.title2.height*3)));
        this.title2.setColor(new cc.Color(255,255,0));
        this.title2.enableStroke(cc.color(255, 0, 0), 1);
//        this.title2.opacity=0;
...
//            this.title2.bigAction = cc.sequence( cc.delayTime(0.3), cc.scaleTo(0.5, 1));

            this.title2.bigAction = cc.sequence(cc.delayTime(0.1), cc.moveTo(0.8, cc.p(this.title2.x, this.title2.y + this.title2.height * 5.5)).easing(cc.easeBounceIn()));
    ...
    disappear: function (callback, target) {
        ...
        var logoAction = cc.sequence(cc.scaleTo(0.5, 0), cc.callFunc(function () {
            ...
            this.title1.bigAction = cc.sequence( cc.delayTime(0.3),cc.scaleTo(0.5, 0));
            this.title1.runAction(this.title1.bigAction);

//            this.title2.bigAction  = cc.scaleTo(0.5, 0);
//            this.title2.runAction(this.title2.bigAction);
            this.title2.runAction(this.title2.bigAction.reverse());
