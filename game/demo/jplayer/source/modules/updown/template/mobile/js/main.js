...
var Swiper = function(a, b) {
    ...
    function f() {
        function a(a) {
            var c = new Image;
            c.onload = function() {
                C && C.imagesLoaded && C.imagesLoaded++,
    ...
    function r() {
        if (H && C.swipeReset(), !b.onlyExternal && C.isTouched) {
            ...
            if ("auto" === b.slidesPerView) {
                for (var n, o = Math.abs(C.getWrapperTranslate()), p = 0, q = 0; q < C.slides.length; q++) if (n = M ? C.slides[q].getWidth(!0) : C.slides[q].getHeight(!0), p += n, p > o) {
                    m = n;
                    break
                }
                m > I && (m = I)
    ...
    function y(a) {
        ...
        d = C.paginationButtons,
        e = 0; e < d.length; e++) c === d[e] && (b = e);
        C.swipeTo(b)
    }
    function z() {
    ...
    if (window.getComputedStyle || (window.getComputedStyle = function(a) {
        ...
        C.init = function(a, c) {
            ...
            if ((d !== C.width || e !== C.height || a) && 0 !== d && 0 !== e) {
                ...
                if (a && C.calcSlides(c), "auto" === b.slidesPerView) {
                    ...
                    b.centeredSlides && (M ? (C.wrapperLeft = (I - this.slides[0].getWidth(!0)) / 2, C.wrapperRight = (I - C.slides[C.slides.length - 1].getWidth(!0)) / 2) : (C.wrapperTop = (I - C.slides[0].getHeight(!0)) / 2, C.wrapperBottom = (I - C.slides[C.slides.length - 1].getHeight(!0)) / 2)),
                    ...
                    for (C.snapGrid = [], C.slidesGrid = [], h = 0, l = 0; l < C.slides.length; l++) {
                        f = C.slides[l].getWidth(!0),
                        g = C.slides[l].getHeight(!0),
                        ...
                        if (b.centeredSlides) {
                            ...
                            else for (var v = 0; v <= Math.floor(q / I); v++) C.snapGrid.push(k + I * v);
                ...
                m.style.height = "",
                i = C.slides[0].getWidth(!0),
                j = C.slides[0].getHeight(!0),
                F = M ? i: j,
                m.style.width = i + "px",
                m.style.height = j + "px",
                E = M ? i: j;
        ...
        C.updateActiveSlide = function(a) {
            if (C.initialized && 0 !== C.slides.length) {
                ...
                if (C.activeIndex === C.slides.length && (C.activeIndex = C.slides.length - 1), C.activeIndex < 0 && (C.activeIndex = 0), C.slides[C.activeIndex]) {
                    ...
                    for (var f = new RegExp("\\s*" + b.slideActiveClass), g = new RegExp("\\s*" + b.slideVisibleClass), h = 0; h < C.slides.length; h++) C.slides[h].className = C.slides[h].className.replace(f, "").replace(g, ""),
                    C.visibleSlides.indexOf(C.slides[h]) >= 0 && (C.slides[h].className += " " + b.slideVisibleClass);
        ...
        C.calcVisibleSlides = function(a) {
            ...
            for (var g = 0; g < C.slides.length; g++) {
                d += e,
                e = "auto" === b.slidesPerView ? M ? C.h.getWidth(C.slides[g], !0) : C.h.getHeight(C.slides[g], !0) : E,
                f = d + e;
                var h = !1;
...
function() {
    ...
    $(document).ready(function(e) {
        ...
        _phoneScale = _width / 640,
        _targetH = 1040 * _phoneScale,
        _swiperslide = $(".swiper-slide"),
        $("#device div").css({
            height: _targetH,
            width: _width
        }),
        ...
        $("#device").css({
            height: _targetH,
            width: _width,
            top: 1008 > _height ? -(1040 * _phoneScale - _height) / 2 : _height
        }), $("#ikea-audio").css({
            height: .0546 * _targetH,
            width: .0881 * _width
        });
        ...
        var _videostart = !1;
        $("#videocontroller").on("click",
        function() {
            audio_switch_ikea && ikea_au.trigger("click"),
            _videostart = !0,
            $("#video").delay(800).show().find("video")[0].play()
        }),
        ...
        var mySwiper = new Swiper("#swiper-container", {
            ...
            onSlideChangeStart: function(a) {
                1 == a.activeIndex && $("#music_audio").length > 0 && audio_switch_ikea && $("#music_audio")[0].play(),
                a.activeIndex < 5 ? $("img.lazy").lazyload({
                    threshold: 2 * _height,
                    skip_invisible: !1
                }) : $("img.lazy").lazyload({
                    threshold: 3 * _height,
            ...
            onSlideChangeEnd: function(a) {
                var b = a.activeSlide();
                $(b).find("img").removeClass("lazy"),
                $(b).find(".draw").animate({
                    opacity: 1
                },
                1e3),
                $(b).find(".info").delay(700).animate({
                    opacity: 1,
                    left: 0
                },
                {
